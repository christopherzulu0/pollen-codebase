  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        <div className="container px-4 md:px-6 mx-auto relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-block bg-[#00CC66]/20 rounded-full p-2 mb-4">
            ...
            <p className="text-white/90 text-lg md:text-xl mb-8 leading-relaxed">
              Have questions about our financial inclusion solutions? Our team is here to help you navigate your journey
          ...
          <Tabs defaultValue="contact" className="w-full max-w-4xl mx-auto" onValueChange={setActiveTab}>
            ...
            <TabsContent value="contact" className="mt-0">
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                <div className="lg:col-span-2">
                  <div className="sticky top-24">
                    ...
                    <div className="space-y-4">
                      <Card className="border-2 border-[#003366]/10 overflow-hidden transition-all duration-300 hover:shadow-md hover:border-[#00CC66]/30">
                ...
                <div className="lg:col-span-3" id="contact-form">
                  <Card className="border-2 border-[#003366]/10">
                    <CardContent className="p-6">
                      {!formSubmitted ? (
                        <>
                          <div className="mb-6">
                            <h2 className="text-2xl font-bold text-[#003366] mb-2">Send Us a Message</h2>
                          ...
                          <div className="w-full bg-gray-200 h-2 rounded-full mb-8">
                            <div
                              className="bg-[#00CC66] h-2 rounded-full transition-all duration-500 ease-in-out"
                          ...
                          <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-between pt-4">
                              ...
                              {formStep < 3 ? (
                                ...
                                <Button
                                  type="submit"
                                  className="bg-[#00CC66] hover:bg-[#00AA55] ml-auto"
            ...
            <TabsContent value="schedule" className="mt-0">
              <Card className="border-2 border-[#003366]/10">
                <CardContent className="p-6">
                  <div className="mb-6">
                    <h2 className="text-2xl font-bold text-[#003366] mb-2">Schedule a Meeting</h2>
                    <p className="text-gray-600">
            ...
            <TabsContent value="directory" className="mt-0">
              <Card className="border-2 border-[#003366]/10">
                <CardContent className="p-6">
                  <div className="mb-6">
                    <h2 className="text-2xl font-bold text-[#003366] mb-2">Contact Directory</h2>
                    <p className="text-gray-600">
      ...
      {!showChatbot && (
        <Button
          onClick={toggleChatbot}
          className="fixed bottom-6 right-6 bg-[#00CC66] hover:bg-[#00AA55] shadow-lg rounded-full h-14 w-14 p-0 flex items-center justify-center animate-in fade-in duration-300"
        >
